...
Compare multiple preprocessing steps in linear regression.
...
I'll start with a very simple model, with all the variables and no preprocessing, except for the creation of dummy variables for all the nominal predictors. 
The `recipes::step_dummy` will create a set of binary dummy variables. By default the excluded dummy will correspond to the first level of the unordered factor.
